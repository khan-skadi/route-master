...
export const GET_ARCHS = "GET_ARCHS";
export const ADD_ARCH = "ADD_ARCH";
export const DELETE_ARCH = "DELETE_ARCH";
export const ARCHS_ERROR = "ARCHS_ERROR";
...
export const ADD_ARCH_START = "ADD_ARCH_START";
export const ADD_ARCH_SUCCESS = "ADD_ARCH_SUCCESS";
export const ADD_ARCH_FAIL = "ADD_ARCH_FAIL";

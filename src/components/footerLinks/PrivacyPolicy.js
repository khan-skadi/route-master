  ...
  return (
    <div className="container">
      ...
      <div style={style}>
        ...
        <p>
          If you are located outside North Macedonia and choose to provide
          information to us, please note that we transfer the data, including
          Personal Data, to North Macedonia and process it there.
        </p>
        <p>
        ...
        <p>
          16. <b>Changes to This Privacy Policy</b>
        </p>
        <p>
